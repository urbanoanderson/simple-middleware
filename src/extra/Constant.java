...
public final class Constant
{
    ...
    private static final KeyPair NAMING_SERVER_KEYPAIR = Encryptor.GenerateKeyPair();
    ...
    private static final KeyPair HOSPITAL_SERVER_KEYPAIR = Encryptor.GenerateKeyPair();
